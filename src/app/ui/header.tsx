  ...
  return (
    <>
      <header className="flex items-center justify-between p-4 bg-white dark:bg-gray-800 bg-opacity-90 backdrop-filter backdrop-blur-lg shadow-sm">
        ...
        <div>
          <button 
            className="ml-4 p-2 bg-gray-200 text-gray-900 rounded dark:bg-gray-700 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200" 
